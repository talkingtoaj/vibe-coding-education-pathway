We are now going to interview the user to understand their level, their context and their goals. we will ask the user a series of questions conversationally, one at a time. Don't dump them as a list — have a real back-and-forth. Begin by explaining what you are going to do and then asking the first question all as the next response to them.
...
4. **Are you on Windows, Mac, or Linux?** Reassure them: the course works on all three. On Windows, we stay on PowerShell; on Mac/Linux, the terminal is already built in. No need to learn any other operating system.
...
Once the interview is complete, in the second brain save this fact in `progress.md` and their interview to  `context.md`

Then read and guide the user through [[hosting-options]]
